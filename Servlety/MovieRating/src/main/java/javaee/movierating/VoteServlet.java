...
public class VoteServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<form method=\"post\" action=\"RatingServlet\">");
            out.println("<input type=\"text\" name=\"name\" required> ");
            out.println("<input type=\"text\" name=\"genre\" required>");
            out.println("<input type=\"number\" name=\"rating\" required>");
            out.println("<button type=\"submit\">Rate</button>");
